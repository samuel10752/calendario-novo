...
if (isset($_POST['campo'])) {
    ...
    if ($campo == "all") {
        ...
        // Buscar a lista de usuários que correspondem à busca e são do tipo "docente"
        $usuarios = $conn->query("SELECT ra_user, nome, email, tipo, COUNT(*) AS total FROM usuario WHERE nome LIKE '%$campo%' AND tipo = 'docente' GROUP BY nome ORDER BY nome");
    }
