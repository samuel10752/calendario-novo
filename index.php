...
<head>
    ...
    <button class="button" onclick="location.href='views/user';">Calendário do usuario</button>
    <button class="button" onclick="location.href='views/adm';">Calendário do Gerente</button>
